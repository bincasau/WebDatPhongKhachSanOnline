        ...
        <form action="DoiMatKhauServlet" method="post">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <span class="input-group-text" onclick="togglePassword('matKhauCu', this)">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <span class="input-group-text" onclick="togglePassword('matKhauMoi', this)">
                        <i class="bi bi-eye-slash"></i>
                    </span>
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <span class="input-group-text" onclick="togglePassword('xacNhanMatKhauMoi', this)">
                        <i class="bi bi-eye-slash"></i>
                    </span>
                </div>
            </div>
