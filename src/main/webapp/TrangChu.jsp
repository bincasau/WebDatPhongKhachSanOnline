...
<body>
	...
	<nav class="navbar navbar-light bg-light px-3">
		<div class="container d-flex justify-content-between align-items-center">
			...
			<div class="d-flex align-items-center">
				...
				%>
				<span class="fw-bold me-3">Xin chào, <%=kh.getTenKhachHang()%></span>
				<div class="dropdown">
			...
			<form action="LocDiaChiServlet" method="GET">
				<div class="row align-items-center">
					<div class="col-md-4">
						...
						<select name="khuVuc" class="form-select">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4 mb-4">
				<a href="ChiTietPhongKhachSan.jsp?id=<%=ks.getMaKhachSan()%>" class="text-decoration-none text-dark">
					<div class="card shadow-sm">
						...
						<div class="card-body">
							...
							<p class="card-text text-warning">⭐ Đánh giá: <strong><%=ks.getDanhGiaTrungBinh()%></strong></p>
						</div>
					</div>
				</a>
			</div>
	...
	<footer class="custom-footer">
		<p><strong>Mọi chi tiết vui lòng liên hệ người quản lý khách sạn.</strong></p>
	</footer>
