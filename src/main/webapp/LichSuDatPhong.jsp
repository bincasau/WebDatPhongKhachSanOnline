...
<head>
    ...
    <style>
        ...
        .orange-bg { background-color: #ffcc99; }
        ...
        .card-body p { font-size: 1rem; color: #333; }
        .card-body p strong { color: #007bff; }
        .color-legend { margin-bottom: 30px; }
        .status-icon {
            font-size: 1.5rem;
            margin-right: 10px;
            color: #333;
...
<div class="text-start mb-4">
    <a href="TrangChu.jsp" class="btn btn-secondary"> <i class="bi bi-house-door-fill"></i> Về trang chủ </a>
</div>
...
<div class="container mt-5">
    ...
    <div class="color-legend mb-4">
        ...
        <ul>
            <li><span class="badge" style="background-color: #d4edda;"></span> Phòng chưa trả - <strong>Xanh lá</strong></li>
            <li><span class="badge" style="background-color: #f0f0f0;"></span> Phòng đã trả - <strong>Xám</strong></li>
            <li><span class="badge" style="background-color: #ffcc99;"></span> Phòng đang sử dụng - <strong>Cam</strong></li>
        </ul>
    </div>
...
<%
    ...
    for (int i = danhSach.size() - 1; i >= 0; i--) {
        ...
        if ("Đã hủy".equals(dp.getTrangThai())) {
            continue; 
        }
        ...
        <div class="card <%=bgClass%>">
            ...
            <div class="card-body">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <p><strong>Khách sạn:</strong> <%=tenKhachSan%></p>
                </div>
                <div class="d-flex align-items-center mb-3">
                ...
                <div class="d-flex align-items-center mb-3">
                    ...
                    <p><strong>Nhận phòng:</strong> <%=dp.getNgayNhanPhong()%> — 
                       <strong>Trả phòng:</strong> <%=dp.getNgayTraPhong()%></p>
                </div>
                <div class="mb-3">
                    <p><strong>Thời gian sử dụng:</strong> <%=dp.getTgSuDung()%> ngày</p>
            ...
            <div class="card-footer text-center">
                <% if (bgClass.equals("gray-bg")) { %>
                    <a href="DanhGia.jsp?TenKhachSan=<%=java.net.URLEncoder.encode(tenKhachSan, "UTF-8")%>&maKhachSan=<%=dp.getMaKhachSan()%>"
                       class="btn btn-primary">Đánh giá</a>
                <% } %>
                <% if (bgClass.equals("green-bg")) { %>
                    <button class="btn btn-danger ms-2" onclick="showCancelModal('<%=dp.getMaDatPhong()%>')">Hủy đặt phòng</button>
                <% } %>
            </div>
        </div>
    </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="confirmCancelModalLabel">Xác nhận hủy đặt phòng</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Đóng"></button>
      </div>
      <div class="modal-body">
        Bạn có chắc chắn muốn hủy đặt phòng <strong id="maDatPhongModal"></strong> không?
      </div>
      <div class="modal-footer">
        <form action="HuyDatPhongServlet" method="post">
          <input type="hidden" name="maDatPhong" id="maDatPhongInput">
...
<!-- Bootstrap + Script xử lý modal -->
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
<script>
function showCancelModal(maDatPhong) {
    const modal = new bootstrap.Modal(document.getElementById('confirmCancelModal'));
    document.getElementById('maDatPhongModal').textContent = maDatPhong;
    document.getElementById('maDatPhongInput').value = maDatPhong;
    modal.show();
}
</script>
</body>
